...
class ReceiptFragment : BaseFragment() {
    ...
    lateinit var edt_rf_transbankname: EditText
    lateinit var edt_rf_transbranchname: EditText
    ...
    override fun onCreateView(
        ...
        edt_rf_transbankname = view.findViewById(R.id.transaction_bankname) as EditText
        edt_rf_transbranchname = view.findViewById(R.id.transaction_branchname) as EditText
        ...
        edt_rf_transbankname.setOnClickListener{
            BankListSpinner.showSpinerDialog()
        }
        BankListSpinner.bindOnSpinerListener(object : OnSpinnerItemClick {
            override fun onClick(var1: String?, var2: Int, var3: String?) {
                ...
                if (SelectedPaymenttypename.equals("Cheque")) {
                    ...
                    // mounika 17-07-2023
                }else if(SelectedPaymenttypename.equals("RTGS/NEFT")){
                    edt_rf_transbankname.setText(SelectedBAnkName.toString())
        ...
        txt_rf_receiptdat.setOnClickListener {
            if (getPrefsBoolean(Constants.IS_ONLINE, true)) {
                ...
                var fromDatePickerDialog: DatePickerDialog = context?.let { it1 ->
                    DatePickerDialog(
                ...
                receiptamount > 0 -> if (!SelectedPaymenttypeid.isEmpty()) {
                    if (SelectedPaymenttypename.equals("Cheque")) {
                        ...
                        transactiondate = str_transdate
                            // added by monica for bank and branch details
                        chequebranch = edt_rf_transbranchname.text.toString().trim()
                        chequebank = edt_rf_transbankname.text.toString().trim()
                        advance = txt_rf_advanceamnt.text.toString().trim()
                        println("transno $transactionno , transdate $transactiondate , chebrnch $chequebranch , chebank $chequebank")
    ...
    private fun add_receipt(
        ...
        if (getPrefsBoolean(Constants.IS_ONLINE, true)) {
            if (AdvanceOnly) {
                ...
                loginparameters.put("adv_receipt_amount", receiptamount)
                            ...
                            response.isSuccessful -> {
                                when {
                                    response.code().equals(200) -> {
                                        ...
                                        //mounica
                                       // bundle.putString("pending_amount", to_be_collected)
            ...
            offlinedb.addOfflineReceiptdetails(
                ...
                remarks,
                "No",
                Constants.isEmtytoZero(adv_receipt_amount),
            ...
            if (AdvanceOnly) {
                ...
                if (payt.equals("Cheque", ignoreCase = true)) {
                    ...
                    offlinedb.update_off_advance(enrolid, Constants.isEmtytoZero(adv_receipt_amount).toInt())
                }
                val bundle = Bundle()
